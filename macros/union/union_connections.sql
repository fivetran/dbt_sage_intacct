{% macro sage_intacct_union_connections(connection_dictionary, single_source_name, single_table_name, default_identifier=single_table_name) %}

{{ adapter.dispatch('sage_intacct_union_connections', 'sage_intacct') (connection_dictionary, single_source_name, single_table_name, default_identifier) }}

{%- endmacro %}

{% macro default__sage_intacct_union_connections(connection_dictionary, single_source_name, single_table_name, default_identifier=single_table_name) %}
...
{# For unioning #}
    ...
    {%- if relations != [] -%}
        {{ sage_intacct.sage_intacct_union_relations(relations) }}
