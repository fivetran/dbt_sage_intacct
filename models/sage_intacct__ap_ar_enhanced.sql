...
ap_bill_enhanced as (
    ...
    cast(ap_bill_item.department_name as {{ dbt_utils.type_string() }}) as department_name, 
    ap_bill_item.entry_date_at,
    ap_bill_item.entry_description,
    ap_bill_item.item_id,
    ap_bill_item.item_name,
    ap_bill_item.line_no,
    cast(ap_bill_item.line_item as {{ dbt_utils.type_string() }}) as line_item,
	...
	cast(ap_bill.due_in_days as {{ dbt_utils.type_string() }}) as due_in_days,
    ap_bill.total_due,
...
ar_invoice_enhanced as (
    ...
    cast(ar_invoice_item.department_name as {{ dbt_utils.type_string() }}) as department_name, 
    ...
    cast(ar_invoice_item.line_item as {{ dbt_utils.type_string() }}) as line_item,
    ...
    cast(ar_invoice.due_in_days as {{ dbt_utils.type_string() }}) as due_in_days,
